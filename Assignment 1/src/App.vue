        ...
        <div class="row">
            <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                <div class="panel panel-primary">
                    <div class="panel-heading text-center">Your TODO List</div>
                    <div class="panel-body">
                        <progress-bar :list="todoList" />
                        <form>
                            <div class="input-group">
                                ...
                                <div class="input-group-btn">
                                    <button class="btn btn-default" @click.prevent="add">
                        ...
                        <div class="alert alert-danger" v-if="listFull">
                            <strong>Sorry!</strong>
                            Your List is <b>FULL</b> Please, delete one or more items.
                        </div>
